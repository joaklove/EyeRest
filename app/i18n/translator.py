...
_STRINGS: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "settings.sound_bowl": "颂钵悠远",
        "settings.sound_woodfish": "木鱼清脆",
        "settings.sound_temple_bell": "钟声深远",
    ...
    "en": {
        ...
        "settings.sound_bowl": "Singing bowl",
        "settings.sound_woodfish": "Wooden fish",
        "settings.sound_temple_bell": "Temple bell",
