...
_STRINGS: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "main.dashboard_placeholder": "Dashboard 未初始化",
        "main.stats_placeholder": "统计页面（未初始化）",
        "main.settings_placeholder": "设置页面（未初始化）",
        # ---- Dashboard ----
        ...
        "position.hint": "拖动角色到你想要的位置，然后保存（Esc 取消）",
        "position.save": "保存位置",
        "position.cancel": "取消",
    ...
    "en": {
        ...
        "position.hint": "Drag the character where you want it, then save (Esc to cancel)",
